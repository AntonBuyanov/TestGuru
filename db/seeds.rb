...
users = User.create!([
                       { name: 'Антон', email: 'buianoff-anton@yandex.ru', password: '123123' },
                       { name: 'Юрий', email: 'uri_dev@mail.ru', password: '123123' },
                       { name: 'Петр', email: 'petr_sidorov@mail.ru', password: '123123' }
                     ])
